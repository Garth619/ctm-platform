...
<div class="container<?php if ($hide_title) : ?> hide-title<?php endif; ?>">
    <div class="row align-items-center">
        <?php if ($breadcrumbs) : ?>
            <div class="breadcrumbs-wrap col-lg-6<?php if ($sub_title) : ?> breadcrumbs-with-subtitle<?php endif; ?>">
        ...
        ?>
        <div class="col-lg-6 text-right<?php if ($hide_title) : ?> d-none<?php endif; ?>">
