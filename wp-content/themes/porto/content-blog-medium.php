                                ...
                                if ($attachment) {
                                    ...
                                    <a href="<?php echo esc_url( apply_filters( 'the_permalink', get_permalink() ) ) ?>">
                                        <div class="img-thumbnail">
                                            <img class="owl-lazy img-responsive" width="<?php echo $attachment_medium['width'] ?>" height="<?php echo $attachment_medium['height'] ?>" src="<?php echo esc_url( $placeholder[0] ); ?>" data-src="<?php echo $attachment_medium['src'] ?>" alt="<?php echo $attachment_medium['alt'] ?>" />
