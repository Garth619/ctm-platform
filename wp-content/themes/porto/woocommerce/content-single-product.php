...
if ( $porto_product_layout == 'default' || $porto_product_layout == 'sticky_info' || $porto_product_layout == 'left_sidebar' ) {
    $summary_before_classes[] = 'col-md-6';
    $summary_classes[] = 'col-md-6';
} else if ( $porto_product_layout == 'full_width' ) {
...
} else if ( $porto_product_layout == 'sticky_both_info' || $porto_product_layout == 'centered_vertical_zoom' ) {
    $summary_before_classes[] = 'col-lg-6';
