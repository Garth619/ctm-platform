...
switch ($cols) {
    ...
    case 4: $cols_md = 3; $cols_xs = 3; $cols_ls = 2; break;
    case 5: $cols_md = 4; $cols_xs = 3; $cols_ls = 2; break;
    case 6: $cols_md = 5; $cols_xs = 3; $cols_ls = 2; break;
    case 7:
        if ( $porto_layout == 'wide-left-sidebar' || $porto_layout == 'wide-right-sidebar' || $porto_layout == 'widewidth' ) {
            $cols = 6; $cols_xl = 7;
        }
        $cols_md = 5; $cols_xs = 3; $cols_ls = 2;
        break;
    case 8:
        if ( $porto_layout == 'wide-left-sidebar' || $porto_layout == 'wide-right-sidebar' || $porto_layout == 'widewidth' ) {
            $cols = 7; $cols_xl = 8;
        }
        $cols_md = 6; $cols_xs = 4; $cols_ls = 2;
        break;
...
} else if ( porto_is_ajax() && isset( $porto_settings['product-infinite'] ) && $porto_settings['product-infinite'] ) {
...
if (isset($porto_woocommerce_loop['view']) && ($porto_woocommerce_loop['view'] == 'products-slider' || $porto_woocommerce_loop['view'] == 'product-carousel')) :
    ?> data-plugin-options="<?php echo esc_attr($options) ?>"<?php endif; ?><?php echo $attrs; ?>>