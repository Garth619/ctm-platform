...
<?php if( 'v2' == porto_cart_version() && is_cart() ) :  ?>
	<div class="card card-default woocommerce-shipping-totals shipping">
		<div class="card-header arrow">
			<h2 class="card-title"><a class="accordion-toggle collapsed out" data-toggle="collapse" href="#panel-cart-shipping" aria-expanded="false"><?php esc_html_e( 'ESTIMATE SHIPPING AND TAX', 'porto' ); ?></a></h2>
		</div>
