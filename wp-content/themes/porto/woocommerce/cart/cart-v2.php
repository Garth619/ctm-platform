				...
				<div class="box-content">
					<form class="woocommerce-cart-form" action="<?php echo esc_url( version_compare($porto_woo_version, '2.5', '<') ? WC()->cart->get_cart_url() : wc_get_cart_url() ); ?>" method="post">
										...
										<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
											...
											<td class="product-thumbnail"><?php
												...
												if ( ! $product_permalink ) {
													...
													printf( '<a href="%s">%s</a>', $_product->get_permalink( $cart_item ), $thumbnail ); // PHPCS: XSS ok.
												}
											?></td>
						...
						<div class="cart-actions">
							<a class="btn btn-default" href="<?php echo get_permalink( wc_get_page_id( 'shop' ) ); ?>"><?php esc_html_e( 'Continue Shopping', 'porto' ); ?></a>
