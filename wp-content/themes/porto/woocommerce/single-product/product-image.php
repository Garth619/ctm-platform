...
if ( 'grid' === $porto_product_layout ) {
    ...
    if ( 'extended' === $porto_product_layout ) {
        $product_images_classes .= ' ccols-3 ccols-sm-1';
    } else {
...
<div class="product-images images">
    ...
    if ( $product->get_image_id() ) {
        ...
        $html .= '<img src="' . esc_url( $image_single_link ) . '" href="' . esc_url( $image_link ) . '" class="woocommerce-main-image img-responsive" alt="' . $image_title . '" width="'. esc_attr( $width ) .'" height="'. esc_attr( $height ) .'" itemprop="image" content="'. esc_url( $image_link ) .'" />';
    ...
    if ( $porto_settings['product-image-popup'] && ( $porto_product_layout === 'default' || $porto_product_layout === 'full_width' || $porto_product_layout === 'transparent' || $porto_product_layout === 'centered_vertical_zoom' || $porto_product_layout === 'extended' || $porto_product_layout === 'left_sidebar' ) ) {
