...
$is_wide = ( 'wide' == $body_type || $porto_layout == 'widewidth' || $porto_layout == 'wide-left-sidebar' || $porto_layout == 'wide-right-sidebar' );
...
/* logo css */
if ( !isset( $porto_settings['logo-type'] ) || $porto_settings['logo-type'] !== 'text' ) :
...
?>
    ...
    @media (min-width: <?php echo ($porto_settings['container-width'] + $porto_settings['grid-gutter-width']) ?>px) {
        #header .logo { max-width: <?php echo $logo_width_wide ?>px; }
    }
    @media (max-width: 991px) {
        #header .logo { max-width: <?php echo $logo_width_tablet ?>px; }
    }
    @media (max-width: 767px) {
        #header .logo { max-width: <?php echo $logo_width_mobile ?>px; }
    }
    <?php if ( $b['change-header-logo'] ) : ?>
        #header.sticky-header .logo { width: <?php echo $logo_width_sticky * 1.25 ?>px; }
    <?php endif; ?>
<?php endif;
...
if ( 'no' !== $loading_overlay && ( 'yes' === $loading_overlay || ( 'yes' !== $loading_overlay && $b['show-loading-overlay'] ) ) ) : ?>
    ...
    .loading-overlay .loader { display: inline-block; border: 2px solid transparent; width: 40px; height: 40px; -webkit-animation: spin 0.75s infinite linear; animation: spin 0.75s infinite linear; border-image: none; border-radius: 50%; vertical-align: middle; position: absolute; margin: auto; left: 0; right: 0; top: 0; bottom: 0; z-index: 2; border-top-color: <?php echo $b['skin-color'] ?>; }
...
<?php if ( $b['header-top-border']['border-top'] && '0px' != $b['header-top-border']['border-top'] ) : ?>
    #header { border-top: <?php echo $b['header-top-border']['border-top']; ?> solid <?php echo $b['header-top-border']['border-color']; ?> }
<?php endif; ?>
@media (min-width: 992px) {
    <?php if ( $b['header-margin']['margin-top'] || $b['header-margin']['margin-bottom'] || $b['header-margin']['margin-left'] || $b['header-margin']['margin-right'] ) :
        if ( $rtl ) {
    ...
    <?php if ( $b['header-margin']['margin-top'] && $b['logo-overlay'] && $b['logo-overlay']['url'] ) : ?>
        #header.logo-overlay-header .overlay-logo { top: -<?php echo $b['header-margin']['margin-top']; ?>px }
        #header.logo-overlay-header.sticky-header .overlay-logo { top: -<?php echo (int)$b['header-margin']['margin-top'] + 90; ?>px }
    <?php endif; ?>
}

<?php if ( isset( $porto_settings['logo-type'] ) && $porto_settings['logo-type'] == 'text' ) : ?>
    @media (max-width: 575px) {
        #header .logo-text { font-size: <?php echo (float)$b['logo-font']['font-size'] * $body_mobile_font_size_scale ?>px; line-height: <?php echo $b['logo-font']['line-height'] * $body_mobile_line_height_scale ?>px; }
    }
<?php endif; ?>
...
<?php if ( isset( $porto_settings['header-main-padding-mobile'] ) && ( $porto_settings['header-main-padding-mobile']['padding-top'] || $porto_settings['header-main-padding-mobile']['padding-bottom'] ) ) : ?>
    @media (max-width: 991px) {
        ...
        #header .header-main .header-right { padding-top: <?php echo $porto_settings['header-main-padding-mobile']['padding-top'] ?>px; padding-bottom: <?php echo $porto_settings['header-main-padding-mobile']['padding-bottom'] ?>px }
    }
<?php endif; ?>
...
if ( isset( $porto_product_layout ) && $porto_product_layout ) : ?>
    ...
    <?php elseif ( 'extended' === $porto_product_layout ) : ?>
        ...
        .product-layout-extended .entry-summary .quantity { position: relative; margin-<?php echo $right; ?>: 20px; color: #8798a1; }
        ...
        @media (min-width: 576px) {
            ...
            .product-layout-extended .variations tr:last-child { margin-<?php echo $right; ?>: 0; }
    ...
    <?php elseif ( 'full_width' === $porto_product_layout ) : ?>
        ...
        @media (max-width: 1679px) {
            .single-product .product-thumbnails { top: 20px; <?php echo $left; ?>: 20px; }
        ...
        @media (max-width: 991px) {
            ...
            .single-product .product-thumbnails { <?php echo $left; ?>: <?php echo $porto_settings['grid-gutter-width'] / 2; ?>px; }
        }
        ...
        @media (max-width: 575px) {
            ...
            .product-summary-wrap { padding-left: <?php echo $porto_settings['grid-gutter-width'] / 2; ?>px; padding-right: <?php echo $porto_settings['grid-gutter-width'] / 2; ?>px; }
            .single-product .product-summary-wrap .product-share { <?php echo $right; ?>: 0; }
        }
        ...
        @media (min-width: 576px) {
            ...
            .single-product .variations tr:last-child { margin-<?php echo $right; ?>: 0; }
    ...
    <?php elseif ( 'transparent' === $porto_product_layout ) : ?>
        ...
        .product-thumbs-vertical-slider .img-thumbnail.selected { border-color: <?php echo $b['skin-color']; ?> }
...
if ( isset( $b['mainmenu-toplevel-link-color-sticky'] ) && $b['mainmenu-toplevel-link-color-sticky'] ) :
    if ( isset( $b['mainmenu-toplevel-link-color-sticky']['regular'] ) && $b['mainmenu-toplevel-link-color-sticky']['regular'] ) : ?>
        ...
        #header.sticky-header .main-menu > li.menu-custom-content a { color: <?php echo $b['mainmenu-toplevel-link-color-sticky']['regular']; ?> }
    <?php endif;
    if ( isset( $b['mainmenu-toplevel-link-color-sticky']['hover'] ) && $b['mainmenu-toplevel-link-color-sticky']['hover'] ) : ?>
        ...
        #header.sticky-header .main-menu > li.menu-custom-content:hover a { color: <?php echo $b['mainmenu-toplevel-link-color-sticky']['hover']; ?> }
    <?php endif;
    if ( isset( $b['mainmenu-toplevel-link-color-sticky']['active'] ) && $b['mainmenu-toplevel-link-color-sticky']['active'] ) : ?>
        ...
        #header.sticky-header .main-menu > li.menu-custom-content.active a { color: <?php echo $b['mainmenu-toplevel-link-color-sticky']['active']; ?> }
    <?php endif;
endif;
...
?>      
        ...
        .shop-loop-before .porto-product-filters-toggle { float: <?php echo $left; ?>; height: 34px; margin-<?php echo $right; ?>: 10px; padding: 0; background: none; margin-bottom: 0; }
        .porto-product-filters-toggle a { position: relative; width: 46px; height: 26px; background: #e6e6e6; border-radius: 13px; transition: all .3s linear; margin-<?php echo $left; ?>: 8px; }
        ...
        .porto-product-filters-toggle.opened a { background-color: <?php echo $b['skin-color']; ?>; }
        ...
        @media (min-width: 992px) {
            .shop-loop-before { text-align: <?php echo $right; ?>; padding-left: 20px; padding-right: 20px; }
            .porto-product-filters-toggle + .woocommerce-ordering { display: inline-block; float: none; margin-<?php echo $right; ?>: 20px; }
            .woocommerce-result-count { margin-<?php echo $left; ?>: 20px; }
            ...
            .main-content-wrap .left-sidebar { <?php echo $left; ?>: -25%; }
            .main-content-wrap .right-sidebar { <?php echo $right; ?>: -25%; }
            .main-content-wrap .main-content { transition: all 0.3s linear 0s; }
            .main-content-wrap:not(.opened) .main-content { margin-<?php echo $left; ?>: -25%; max-width: 100%; -webkit-flex: 0 0 100%; -ms-flex: 0 0 100%; flex: 0 0 100%; min-height: 1px; }
            .column2-right-sidebar .main-content-wrap:not(.opened) .main-content { margin-<?php echo $right; ?>: -25%; margin-<?php echo $left; ?>: 0; }
            .main-content-wrap.opened .sidebar { z-index: 0; visibility: visible; }
            .main-content-wrap.opened .left-sidebar { <?php echo $left; ?>: 0; }
            .main-content-wrap.opened .right-sidebar { <?php echo $right; ?>: 0; }
            .main-content-wrap.opened .main-content { margin-<?php echo $left; ?>: 0; }
            .column2-right-sidebar .main-content-wrap.opened .main-content { margin-<?php echo $right; ?>: 0; }
    ...
    <?php if ( $is_wide ) : ?>
        @media (min-width: 1500px) {
            .main-content-wrap .left-sidebar { <?php echo $left; ?>: -20%; }
            .main-content-wrap .right-sidebar{ <?php echo $right; ?>: -20%; }
            .main-content-wrap:not(.opened) .main-content { margin-<?php echo $left; ?>: -20%; }
        }
    <?php endif; ?>
...
?>
        ...
        .porto_widget_price_filter .widget-title .toggle { display: inline-block; width: 1.8571em; height: 1.8571em; line-height: 1.7572em; position: absolute; <?php echo $right; ?>: -7px; top: 50%; margin-top: -0.9em; padding: 0; cursor: pointer; font-family: "porto"; text-align: center; transition: all 0.25s ease 0s; color: #21293c; font-size: 17px; }
        ...
        .woocommerce-ordering select { margin-<?php echo $left; ?>: 0; text-transform: uppercase; }
        ...
        @media (min-width: 992px) and (max-width: <?php echo $b['container-width'] + $b['grid-gutter-width'] - 1; ?>px) {
...
if ( class_exists( 'Woocommerce' ) && !is_checkout() && !is_user_logged_in() && ( !isset( $porto_settings['woo-account-login-style'] ) || !$porto_settings['woo-account-login-style'] ) ) : ?>
    ...
    #login-form-popup .featured-box h2 { text-transform: uppercase; font-size: 15px; letter-spacing: 0.05em; font-weight: 600; color: <?php echo $b['h2-font']['color']; ?>; line-height: 2; }
    .porto-social-login-section { background: #f4f4f2; text-align: center; padding: 20px 20px 25px; }
    .porto-social-login-section p { text-transform: uppercase; font-size: 12px; color: <?php echo $b['h4-font']['color']; ?>; font-weight: 600; margin-bottom: 8px; }
    #login-form-popup .col2-set { margin-left: -20px; margin-right: -20px; }
    #login-form-popup .col-1, #login-form-popup .col-2 { padding-left: 20px; padding-right: 20px; }
    @media (min-width: 992px) {
        #login-form-popup .col-1 { border-<?php echo $right; ?>: 1px solid #f5f6f6; }
    }
    ...
    #login-form-popup .button { border-radius: 2px; padding: 10px 24px; text-transform: uppercase; text-shadow: none; <?php if ( isset( $b['add-to-cart-font'] ) && !empty( $b['add-to-cart-font']['font-family'] ) ) { echo 'font-family: '. esc_attr( $b['add-to-cart-font']['font-family'] ) .';'; } ?> font-size: 12px; letter-spacing: 0.025em; color: #fff; }
    #login-form-popup label.inline { margin-top: 15px; float: <?php echo $right; ?>; position: relative; cursor: pointer; line-height: 1.5; }
    #login-form-popup label.inline input[type=checkbox] { opacity: 0; margin-<?php echo $right; ?>: 8px; margin-top: 0; margin-bottom: 0; }
    #login-form-popup label.inline span:before { content: ''; position: absolute; border: 1px solid #ddd; border-radius: 1px; width: 16px; height: 16px; <?php echo $left; ?>: 0; top: 0; text-align: center; line-height: 15px; font-family: FontAwesome; font-size: 9px; color: #aaa }
    ...
    #login-form-popup .social-button i { font-size: 16px; margin-<?php echo $right; ?>: 8px; }
    #login-form-popup p.status { color: <?php echo $b['h4-font']['color']; ?>; margin-bottom: 0; }
