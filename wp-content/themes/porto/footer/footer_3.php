...
?>
<div id="footer" class="footer-3<?php if ($porto_settings['footer-ribbon']) echo ' show-ribbon' ?>"<?php if ($porto_settings['footer-parallax']) echo ' data-plugin-parallax data-plugin-options="{&quot;speed&quot;: ' . esc_attr($porto_settings['footer-parallax-speed']) . '}" style="background-image: none !important;"' ?>>
