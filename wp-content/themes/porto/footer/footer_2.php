...
?>
<div id="footer" class="footer-2<?php if ($porto_settings['footer-ribbon']) echo ' show-ribbon' ?>"<?php if ($porto_settings['footer-parallax']) echo ' data-plugin-parallax data-plugin-options="{&quot;speed&quot;: ' . esc_attr($porto_settings['footer-parallax-speed']) . '}" style="background-image: none !important;"' ?>>
        ...
        <div class="container">
            ...
            <div class="footer-left">
                ...
                if ($porto_settings['footer-copyright-pos'] == 'left') {
                    echo '<span class="footer-copyright">'. force_balance_tags($porto_settings['footer-copyright']) .'</span>';
            ...
            <?php if ($porto_settings['footer-copyright-pos'] == 'right') { ?>
                <div class="footer-right"><?php echo '<span class="footer-copyright">'. force_balance_tags($porto_settings['footer-copyright']) .'</span>'; ?></div>
