...
if ($porto_settings['share-facebook']) :
    ?><a href="https://www.facebook.com/sharer.php?u=<?php echo $permalink; ?>" <?php echo $extra_attr ?> title="<?php echo __('Facebook', 'porto') ?>" class="share-facebook"><?php echo __('Facebook', 'porto') ?></a><?php
endif;
...
if ($porto_settings['share-whatsapp']) :
    ?><a href="whatsapp://send?text=<?php echo rawurlencode( $title ). ' - ' .$permalink ?>" data-action="share/whatsapp/share" <?php echo $nofollow . $tooltip ?> title="<?php echo __('WhatsApp', 'porto') ?>" class="share-whatsapp" style="display:none"><?php echo __('WhatsApp', 'porto') ?></a><?php
endif;
