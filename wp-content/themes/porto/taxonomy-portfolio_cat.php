...
<div id="content" role="main" class="<?php if ($porto_layout === 'widewidth' || $porto_layout === 'wide-left-sidebar' || $porto_layout === 'wide-right-sidebar') { echo 'm-t-lg m-b-xl'; if (porto_get_wrapper_type() !=='boxed') echo ' m-r-md m-l-md'; } ?>">
    ...
    <?php if (have_posts()) : ?>
        ...
        <?php if ($porto_settings['portfolio-archive-link-zoom']) : ?><div class="portfolios-lightbox<?php if( $porto_settings[ 'portfolio-archive-img-lightbox-thumb' ] ) { echo " with-thumbs"; }?>"><?php endif; ?>
        ...
        <div class="page-portfolios portfolios-<?php echo $portfolio_layout ?> clearfix">
            ...
            <section class="timeline">
                ...
                <div class="timeline-body<?php if ($portfolio_infinite) echo ' portfolios-container' ?>">

            <?php else : ?>

            <div class="clearfix<?php if ($portfolio_infinite) : ?> portfolios-container<?php endif; ?><?php if ($portfolio_layout == 'grid' || $portfolio_layout == 'masonry') : ?> portfolio-row portfolio-row-<?php echo $portfolio_columns ?> <?php echo $portfolio_view ?><?php endif; ?>">
...
$porto_portfolio_view = $porto_portfolio_thumb = $porto_portfolio_thumb_bg = $porto_portfolio_thumb_image = $porto_portfolio_thumbs_html =  '';
?>
