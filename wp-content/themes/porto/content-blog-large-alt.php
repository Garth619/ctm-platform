...
<article <?php post_class($post_class); ?>>
  ...
  <?php endif; ?>
        ...
        <?php
                        foreach ($featured_images as $featured_image) {
                            ...
                            <a href="<?php echo esc_url( apply_filters( 'the_permalink', get_permalink() ) ) ?>">
                              <div class="img-thumbnail"> <img class="owl-lazy img-responsive" width="<?php echo $attachment_large['width'] ?>" height="<?php echo $attachment_large['height'] ?>" data-src="<?php echo $attachment_large['src'] ?>" alt="<?php echo $attachment_large['alt'] ?>" />
    ...
    <div class="post-image single">
      <div class="img-thumbnail fit-video"> <?php echo do_shortcode($video_code) ?> </div>
    </div>
    <?php
                }
            }
