...
switch ( $source ) {
    ...
    case 'external_link':
        ...
        $img = array(
            'thumbnail' => '<img class="vc_single_image-img" ' . $hwstring . ' src="' . $custom_src . '" alt="" />'
        );
        break;
...
if ( ! $img ) {
    $img['thumbnail'] = '<img class="vc_img-placeholder vc_single_image-img" src="' . $default_src . '" alt="" />';
}
...
if ($lightbox && $onclick == 'img_link_large') {
    ...
    if ($image_gallery && $container_class != 'vc_row')
