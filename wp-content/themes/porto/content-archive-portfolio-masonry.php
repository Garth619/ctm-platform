                ...
                <span class="thumb-info <?php echo $class ?>">
                    <span class="thumb-info-wrapper">
                        ...
                        <?php endif; 
                            ...
                            foreach ($featured_images as $featured_image) :
                                $attachment_id = $featured_image['attachment_id'];
                                $attachment = porto_get_attachment($attachment_id, $portfolio_columns >= 3 ? 'portfolio-masonry' : 'full');
                                ...
                                if ($attachment && $attachment_full) :
                                    ...
                                    ?>
                                    <img class="img-responsive" width="<?php echo $attachment['width'] ?>" height="<?php echo $attachment['height'] ?>" src="<?php echo $attachment['src'] ?>" alt="<?php echo $attachment['alt'] ?>" />
                                    <?php
