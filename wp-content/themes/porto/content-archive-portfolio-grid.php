...
if ($count) :
	...
	<article <?php post_class($post_class); ?>>
		...
		<div class="portfolio-item <?php echo $portfolio_view == 'outimage' ? 'outimage' : $portfolio_view ?>">
			...
			<?php if ($portfolio_view == 'outimage') : ?>
				<?php if ($portfolio_columns > 4) :?><h5 class="m-t-md m-b-none portfolio-title"><?php the_title(); ?></h5><?php
				else : ?><h4 class="m-t-md m-b-none portfolio-title"><?php the_title(); ?></h4><?php endif; ?>
				<?php
				if ($sub_title) : ?>
