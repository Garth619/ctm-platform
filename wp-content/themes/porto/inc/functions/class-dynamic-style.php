    ...
    class Porto_Dynamic_Style {
        ...
        public function init() {
            ...
            if ( 'internal' == $this->get_mode() ) {
                add_action( 'wp_head', array( $this, 'output_dynamic_styles' ), 140 );
            }
            if ( !is_customize_preview() ) {
                add_action( 'wp_head', array( $this, 'output_internal_styles' ), 151 );
            }
        ...
        public function compile_dynamic_css() {
            ...
            try {
                ...
                foreach ( $rtl_arr as $rtl_arr_value ) {
                    ...
                    $result = $reduxFramework->filesystem->execute( 'put_contents', $filename, array( 'content' => $css ) );
                    if ( $result ) {
                        $result = true;
                    } else {
                        $result = false;
        ...
        public function output_dynamic_styles() {
            ...
            $upload_dir = wp_upload_dir();
            $css_file = $upload_dir['basedir'] . '/porto_styles/dynamic_style.css';
            echo '<style id="porto-dynamic-css-output">';
            ob_start();
            ...
            echo apply_filters( 'porto_dynamic_style_internal_output', $this->minify_css( $css ) );
            echo '</style>';
        }
        ...
        public function output_internal_styles() {
            ...
            echo '<style id="porto-generated-css-output">';
