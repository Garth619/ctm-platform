    ...
    class Porto_Infinite_Scroll {
        ...
        public function add_scripts() {
            ...
            if ( $this->is_infinite ) {
                ...
                wp_enqueue_script( 'porto-infinite-scroll-js', porto_uri . '/js/jquery.infinite-scroll.min.js', $required, '2.1.0', true );
                wp_enqueue_script( 'porto-infinite-scroll', porto_lib_uri . '/infinite-scroll/infinite-scroll.min.js', array( 'porto-infinite-scroll-js' ), porto_version, true );
