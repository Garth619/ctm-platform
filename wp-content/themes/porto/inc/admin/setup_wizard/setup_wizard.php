...
if ( ! class_exists( 'Porto_Theme_Setup_Wizard' ) ) {
    ...
    class Porto_Theme_Setup_Wizard {
        ...
        private function porto_demo_types() {
            return array(
                ...
                'classic-video-light' => array(
                    ...
                    'filter' => 'classic',
                    'revslider' => array( 'full-width-slider.zip', 'full-width-video.zip', 'home-classic-video-light', 'media-gallery.zip' ),
                ),
                'corporate1' => array(
                    'alt' => 'Corporate 1',
                    'img' => porto_options_uri.'/demos/corporate_1.jpg',
                    'filter' => 'classic',
                    'revslider' => array( 'full-width-slider.zip', 'full-width-video.zip', 'home-corporate-1.zip', 'media-gallery.zip' ),
                ),
                'corporate2' => array(
                    'alt' => 'Corporate 2',
                    'img' => porto_options_uri.'/demos/corporate_2.jpg',
                    'filter' => 'classic',
                    'revslider' => array( 'full-width-slider.zip', 'full-width-video.zip', 'home-corporate-2.zip', 'media-gallery.zip' ),
                ),
                'corporate3' => array(
                    'alt' => 'Corporate 3',
                    'img' => porto_options_uri.'/demos/corporate_3.jpg',
                    'filter' => 'classic',
                    'revslider' => array( 'full-width-slider.zip', 'full-width-video.zip', 'home-corporate-3.zip', 'media-gallery.zip' ),
                ),
                'corporate4' => array(
                    'alt' => 'Corporate 4',
                    'img' => porto_options_uri.'/demos/corporate_4.jpg',
                    'filter' => 'classic',
                    'revslider' => array( 'full-width-slider.zip', 'full-width-video.zip', 'home-corporate-4.zip', 'media-gallery.zip' ),
                ),
                'corporate5' => array(
                    'alt' => 'Corporate 5',
                    'img' => porto_options_uri.'/demos/corporate_5.jpg',
                    'filter' => 'classic',
                    'revslider' => array( 'full-width-slider.zip', 'full-width-video.zip', 'home-corporate-5.zip', 'media-gallery.zip' ),
                ),
                'corporate6' => array(
                    'alt' => 'Corporate 6',
                    'img' => porto_options_uri.'/demos/corporate_6.jpg',
                    'filter' => 'classic',
                    'revslider' => array( 'full-width-slider.zip', 'full-width-video.zip', 'home-corporate-6.zip', 'media-gallery.zip' ),
                ),
                'corporate7' => array(
                    'alt' => 'Corporate 7',
                    'img' => porto_options_uri.'/demos/corporate_7.jpg',
                    'filter' => 'classic',
                    'revslider' => array( 'full-width-slider.zip', 'full-width-video.zip', 'home-corporate-7.zip', 'media-gallery.zip' ),
                ),
                'corporate8' => array(
                    'alt' => 'Corporate 8',
                    'img' => porto_options_uri.'/demos/corporate_8.jpg',
                    'filter' => 'classic',
                    'revslider' => array( 'full-width-slider.zip', 'full-width-video.zip', 'hhome-corporate-8.zip', 'media-gallery.zip' ),
                ),
        ...
        public function setup_wizard() {
            ...
            wp_register_script( 'porto-admin', porto_js.'/admin/admin.min.js', array( 'jquery', 'porto-magnific-popup' ), $this->version, true );
        ...
        public function porto_setup_wizard_demo_content() {
            ...
            <form method="post" class="porto-install-demos">
                ...
                <?php
                    ...
                    $required_plugins = $portoTGMPlugins->get_plugins_list();
        ...
        private function get_demo_file( $demo = false ) {
            ...
            if ( !$demo_file_path ) {
                echo json_encode( array( 'process' => 'error', 'message' => __( 'Remote API error.', 'porto' ) ) );
                die();
            } elseif( is_wp_error( $demo_file_path ) ) {
                echo json_encode( array( 'process' => 'error', 'message' => $demo_file_path->get_error_message() ) );
                die();
            }
        ...
        function reset_menus() {
            ...
            if ( current_user_can( 'manage_options' ) ) {
                ...
                if ($import_shortcodes) {
                    $menus = array('Main Menu', 'Secondary Menu', 'Top Navigation', 'Home One Page', 'Footer Bottom Links', 'Departments', 'Resources', 'Company', 'Services', 'Shortcodes');
                } else {
        ...
        function import_dummy() {
            ...
            if ( current_user_can( 'manage_options' ) && class_exists( 'WP_Importer' ) && class_exists( 'WP_Import' ) ) { // check for main import class and wp import class
                ...
                if ( 'import_start' == $process && $response ) {
                    echo json_encode( array( 'process' => 'importing', 'count' => 0, 'index' => 0, 'message' => esc_html__('Importing posts', 'porto') ) );
                } else {
        ...
        function import_dummy_end() {
            if ( current_user_can( 'manage_options' ) && 'porto_import_dummy' === $_POST['action'] ) {
                ob_end_clean();
                ob_start();
                echo json_encode( array( 'process' => 'complete', 'message' => esc_html__('Imported posts', 'porto') ) );
                ob_end_flush();
                ob_start();
            }
        }
        ...
        private function import_after_functions( $demo ) {
            ...
            if ( $demo != 'shortcodes' ) {
                ...
                $shortcodes_page = $this->importer_get_page_by_title( 'Shortcodes' );
