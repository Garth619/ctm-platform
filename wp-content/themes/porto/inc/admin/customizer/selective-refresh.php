...
function porto_customizer_refresh_partials( WP_Customize_Manager $wp_customize ) {
    ...
    $wp_customize->selective_refresh->add_partial( 'header_social_links', array(
    ...
    $wp_customize->selective_refresh->add_partial( 'searchform', array(
        'selector' => '#header .searchform-popup',
        'container_inclusive' => true,
        'settings' => array( 'porto_settings[search-type]', 'porto_settings[search-cats]', 'porto_settings[search-sub-cats]' ),
        'render_callback' => function() {
    ...
    $wp_customize->selective_refresh->add_partial( 'breadcrumb', array(
        'selector' => '.page-top',
        'container_inclusive' => true,
        'settings' => array( 'porto_settings[breadcrumbs-parallax]', 'porto_settings[breadcrumbs-parallax-speed]', 'porto_settings[show-pagetitle]', 'porto_settings[show-breadcrumbs]', 'porto_settings[pagetitle-archives]', 'porto_settings[pagetitle-parent]', 'porto_settings[breadcrumbs-prefix]', 'porto_settings[breadcrumbs-blog-link]', 'porto_settings[breadcrumbs-archives-link]', 'porto_settings[breadcrumbs-categories]', 'porto_settings[breadcrumbs-delimiter]', 'porto_settings[breadcrumbs-type]', 'porto_settings[blog-title]' ),
        'render_callback' => function() {
    ...
    $wp_customize->selective_refresh->add_partial( 'blog-content_top', array(
    ...
    $wp_customize->selective_refresh->add_partial( 'blog-content_bottom', array(
    ...
    $wp_customize->selective_refresh->add_partial( 'blog-content_inner_top', array(
    ...
    $wp_customize->selective_refresh->add_partial( 'blog-content_inner_bottom', array(
    ...
    $wp_customize->selective_refresh->add_partial( 'single-post', array(
    ...
    if ( class_exists( 'Woocommerce' ) ) :
        $wp_customize->selective_refresh->add_partial( 'archive-product', array(
        ...
        $wp_customize->selective_refresh->add_partial( 'single-product', array(
        ...
        $wp_customize->selective_refresh->add_partial( 'single-product-meta', array(
        ...
        $wp_customize->selective_refresh->add_partial( 'single-product-related', array(
            'selector' => '.single-product .porto-related-products',
            'fallback_refresh' => false,
            'container_inclusive' => true,
        ...
        $wp_customize->selective_refresh->add_partial( 'single-product-upsells', array(
