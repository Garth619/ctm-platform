...
class Porto_Header_Builder {
    ...
    protected $infinite_elements = array( 'row', 'porto_block', 'html' );
    ...
    public function add_section( $wp_customize ) {
        ...
        if ( $options_style ) {
            $wp_customize->add_section( 'porto_header_layouts', array(
        ...
        $wp_customize->add_setting( 'porto_header_builder[selected_layout]', array(
            'default' => '',
        ...
        $wp_customize->add_control( 'porto_header_layouts_select', array(
        ...
        $wp_customize->add_setting( 'porto_header_layouts_create_text',
            array(
                'default' => '',
                'transport' => $this->transport,
        ...
        $wp_customize->add_control( new Porto_Simple_Notice_Custom_Control( $wp_customize, 'porto_header_layouts_create_text',
           array(
              'description'  => '<a href="#" class="porto_create_new_header_layout_link">'. __( 'Create a new header layout', 'porto' ) .'</a>',
              'section' => 'porto_header_layouts'
           )
        ) );

        $wp_customize->add_control('porto_header_layouts_title', array(
            'type'  => 'text',
        ...
        $wp_customize->add_control( 'porto_header_layouts_create_button', array(
            'type' => 'button',
            'settings' => array(),
            'priority' => 10,
            'section' => 'porto_header_layouts',
        ...
        $wp_customize->add_setting( 'porto_header_layouts_delete',
            array(
                'default' => '',
                'transport' => $this->transport,
                'sanitize_callback' => 'wp_filter_nohtml_kses'
        ...
        $wp_customize->add_control( new Porto_Simple_Notice_Custom_Control( $wp_customize, 'porto_header_layouts_delete',
           array(
              'description'  => '<a href="#" class="porto_delete_header_layout_link">'. __( 'Delete header layout', 'porto' ) .'</a>',
              'section' => 'porto_header_layouts'
           )
        ) );

        $wp_customize->add_setting( 'porto_header_builder[type]', array(
            'default' => '',
            'transport' => $this->transport,
            'capability' => 'edit_theme_options',
            'type' => 'option',
        ) );
        $wp_customize->add_control( 'porto_header_layouts_type', array(
            'type' => 'select',
            'label' => __( 'Type', 'porto' ),
            'section' => 'porto_header_layouts',
        ...
        $wp_customize->add_control( 'porto_header_layouts_block_element', array(
            'type' => 'select',
        ...
        $wp_customize->add_control( 'porto_header_layouts_html_element', array(
            'type' => 'textarea',
            'label' => __('HTML', 'porto'),
            'section' => 'porto_header_layouts',
            'settings' => array(),
        ) );
        $wp_customize->add_control( 'porto_header_layouts_save_html_button', array(
            'type' => 'button',
            'settings' => array(),
            'priority' => 10,
            'section' => 'porto_header_layouts',
        ...
        // custom css
        $wp_customize->add_setting( 'porto_header_builder[custom_css]', array(
            'default' => '',
            'transport' => $this->transport,
            'capability' => 'edit_theme_options',
            'type' => 'option',
        ) );
        $wp_customize->add_control( new WP_Customize_Code_Editor_Control( $wp_customize, 'porto_header_layouts_custom_css', array(
        ...
        $wp_customize->add_section( 'porto_header_builder', array(
            'title'    => __( 'Header Builder Elements', 'porto' ),
            'priority' => 125,
        ) );
        foreach( $this->header_elements as $key => $element ) {
            $wp_customize->add_setting( 'porto_header_builder_elements['. $key .']', array(
                'default' => '',
                'capability' => 'edit_theme_options',
                'type' => 'option',
                'transport' => $this->transport,
            ) );
            $wp_customize->add_control( 'porto_header_builder_elements_' . $key, array(
                'type' => 'text',
        ...
        // selective refresh
        $settings = array( 'porto_header_builder[selected_layout]', 'porto_header_layouts_delete', 'porto_header_builder[type]' );

        $header_elements = array( 'top_left', 'top_center', 'top_right', 'main_left', 'main_center', 'main_right', 'bottom_left', 'bottom_center', 'bottom_right',
                'mobile_top_left', 'mobile_top_center', 'mobile_top_right', 'mobile_main_left', 'mobile_main_center', 'mobile_main_right', 'mobile_bottom_left', 'mobile_bottom_center', 'mobile_bottom_right' );
        foreach( $header_elements as $key) {
            $settings[] = 'porto_header_builder_elements['. $key .']';
        }
        $wp_customize->selective_refresh->add_partial( 'header-wrapper', array(
        ...
        $wp_customize->selective_refresh->add_partial( 'refresh_css_header_builder', array(
            'selector' => 'head > style#porto-dynamic-css-output',
            'container_inclusive' => true,
            'settings' => array( 'porto_header_builder[type]' ),
            'render_callback' => function() {
                global $porto_dynamic_style, $porto_settings;
                $porto_settings['header-type-select'] = 'header_builder';
                if ( $porto_dynamic_style ) {
                    return $porto_dynamic_style->output_dynamic_styles();
                }
            },
        ) );
    }
    ...
    public function add_header_builder_content() {
        ...
        <div class="porto-header-builder">
            <div class="header-builder-header">
                ...
                <div class="actions">
                    <a href="https://youtu.be/hh3CHKv0l74" class="button" target="_blank"><?php esc_html_e( 'Tutorial', 'porto' ); ?></a>
