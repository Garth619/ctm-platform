...
if (!class_exists('Redux_Framework_porto_settings')) {
    class Redux_Framework_porto_settings {
        ...
        public function setSections() {
            ...
            if ( $options_style ) {
                $this->sections[] = $this->add_customizer_field( array(
                    'icon' => 'el-icon-dashboard',
                    'icon_class' => 'icon',
                    'title' => __('General', 'porto'),
                ), false, $general_site_loader_options );
                ...
                $this->sections[] = $this->add_customizer_field( array(
                    ...
                    'icon_class' => 'icon',
                    'title' => __('General', 'porto'),
                ), $options_style, $general_site_loader_options, $general_layout_options );
            }
            ...
            $this->sections[] = $this->add_customizer_field( array(
                ...
                'fields' => array(
                    array(
                        ...
                        'type' => 'raw',
                        'content' => '<img style="max-width: 100%;" src="' . porto_options_uri . '/layouts/theme_layout.jpg" alt="" />',
                    ),
                ),
            ), $options_style );
            $this->sections[] = $this->add_customizer_field( array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'default' => array('padding-top' => 0, 'padding-bottom' => 20),
                    ),
                ),
            );
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'id' => 'goto_header-settings',
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s>Header Layout Settings</a>', 'porto'), 'href="#" class="goto-section"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
                    ...
                    array(
                        'id' => 'goto_porto_header_layouts',
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s>Header Builder</a>', 'porto'), 'href="#" class="goto-section"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
                    ...
                    array(
                        'id' => 'skin_header_info3',
                        'type' => 'info',
                        'title' => __('Sticky Header', 'porto'),
                        'notice' => false,
                    ),
                    array(
                        'id' => 'goto_enable-sticky-header',
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s>Sticky Header Layout Settings</a>', 'porto'), 'href="#" class="goto-section field-control"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
                    ...
                    array(
                        'id' => 'skin_header_info6',
                        'type' => 'info',
                        'title' => wp_kses(
                            sprintf(
                                __('Header Bottom (This is used only if you use header type built using <a href="%s" class="goto-header-builder">Header Builder</a>.)', 'porto'), esc_url(
                                    add_query_arg(
                                        array(
                                            'autofocus' => array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s> Menu Layout Settings</a>', 'porto'), 'href="#" class="goto-section"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
                    ...
                    array(
                        ...
                        'default' => array('padding-top' => 9, 'padding-bottom' => 8, 'padding-left' => 12, 'padding-right' => 12),
                    ),
                    array(
                        ...
                        'desc' => __('This is not working for sidebar menus.', 'porto'),
                        'default' => array('padding-top' => 9, 'padding-bottom' => 8, 'padding-left' => 10, 'padding-right' => 10),
                    ),
                    array(
                        'id' => 'skin_mainmenu_info2',
                        'type' => 'info',
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'id' => 'goto_header-breadcrumb',
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s>Breadcrumbs Layout Settings</a>', 'porto'), 'href="#" class="goto-section"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'id' => 'goto_footer-settings',
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s>Footer Layout Settings</a>', 'porto'), 'href="#" class="goto-section"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'id' => 'goto_mobile-panel-settings',
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s>Mobile Panel Settings</a>', 'porto'), 'href="#" class="goto-section"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'id' => 'goto_header-view-currency-switcher',
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s>View, Currency Switcher Layout Settings</a>', 'porto'), 'href="#" class="goto-section"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'id' => 'goto_header-search-form',
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s>Search Form Layout Settings</a>', 'porto'), 'href="#" class="goto-section"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
                    ...
                    array(
                        ...
                        'validate' => 'color',
                        'output' => array(
                            'border-color' => '#header.sticky-header .searchform-popup .searchform',
                            'border-bottom-color' => '#header.sticky-header .searchform-popup .search-toggle:after',
                        ),
                    ),
                    array(
            ...
            $this->sections[] = $this->add_customizer_field( array(
                ...
                'fields' => array(
                    array(
                        ...
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s>Header Skin Settings</a>', 'porto'), 'href="#" class="goto-section"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'id' => 'header-type-builder',
                        'type' => 'info',
                        'default' => '',
                        'desc' => wp_kses(
                            sprintf(
                                __('You can add new header type using <a href="%s" class="goto-header-builder">Header Builder</a>.', 'porto'), esc_url(
                                    add_query_arg(
                                        array(
                                            'autofocus' => array(
                                                'section' => 'porto_header_layouts',
                    ...
                    array(
                        ...
                        'options' => array(
                            '' => __('Presets', 'porto'),
                            'header_builder' => __('Header builder'),
                        ),
                        'default' => '',
                    ),
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'id' => 'goto_skin-view-currency-switcher',
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s>View, Currency Switcher Skin Settings</a>', 'porto'), 'href="#" class="goto-section"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'id' => 'goto_skin-search-form',
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s>Search Form Skin Settings</a>', 'porto'), 'href="#" class="goto-section"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'id' => 'goto_sticky-header-bg',
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s>Sticky Header Skin Settings</a>', 'porto'), 'href="#" class="goto-section field-control"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'id' => 'goto_skin-mobile-menu',
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s>Mobile Menu Skin Settings</a>', 'porto'), 'href="#" class="goto-section"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
            ...
            $this->sections[] = $this->add_customizer_field( array(
                ...
                'fields' => array(
                    array(
                        'id' => 'goto_skin-main-menu',
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s> Main Menu Skin Settings</a>', 'porto'), 'href="#" class="goto-section"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
            ...
            $this->sections[] = $this->add_customizer_field( array(
                ...
                'fields' => array(
                    array(
                        'id' => 'goto_skin-breadcrumb',
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s>Breadcrumbs Skin Settings</a>', 'porto'), 'href="#" class="goto-section"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
            ...
            $this->sections[] = $this->add_customizer_field( array(
                ...
                'fields' => array(
                    array(
                        ...
                        'type' => 'info',
                        'desc' => wp_kses(
                            sprintf( __( 'Go to <a %s>Footer Skin Settings</a>', 'porto'), 'href="#" class="goto-section"', 'porto' ),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'class' => array(),
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'options' => array(
                            ...
                            "woocommerce" => array('alt' => __('Woocommerce', 'porto'), 'img' => porto_options_uri . '/images/post_archive_style_woocommerce.jpg'),
                        ),
                        'default' => 'full',
                    ),
                    array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'options' => array(
                            ...
                            "style-6" => array('alt' => __('Simple', 'porto'), 'img' => porto_options_uri . '/images/post_style_6.jpg'),
                        ),
                        'default' => '',
                    ),
                    array(
            ...
            ), $options_style, $portfolio_options );
            $this->sections[] = array(
                'icon_class' => 'icon',
                'subsection' => true,
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'options' => array(
                            ...
                            "quantity" => array('alt' => __('On Image, Show Quantity Input', 'porto'), 'img' => porto_options_uri . '/images/product_addlinks_style_6.png'),
                        ),
                        'default' => 'outimage',
                        'transport' => 'postMessage',
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'options' => array(
                            "default" => array('title' => __('Default', 'porto'), 'img' => porto_options_uri . '/products/default.jpg'),
                            "extended" => array('title' => __('Extended', 'porto'), 'img' => porto_options_uri . '/products/extended.jpg'),
                            "full_width" => array('title' => __('Full Width', 'porto'), 'img' => porto_options_uri . '/products/full_width.jpg'),
                            "grid" => array('title' => __('Grid Images', 'porto'), 'img' => porto_options_uri . '/products/grid.jpg'),
                            "sticky_info" => array('title' => __('Sticky Info', 'porto'), 'img' => porto_options_uri . '/products/sticky_info.jpg'),
                            "sticky_both_info" => array('title' => __('Sticky Left & Right Info', 'porto'), 'img' => porto_options_uri . '/products/sticky_info_both.jpg'),
                            "transparent" => array('title' => __('Transparent Images', 'porto'), 'img' => porto_options_uri . '/products/transparent.jpg'),
                            "centered_vertical_zoom" => array('title' => __('Centered Vertical Zoom', 'porto'), 'img' => porto_options_uri . '/products/centered_vertical_zoom.jpg'),
                            "left_sidebar" => array('title' => __('Left Sidebar', 'porto'), 'img' => porto_options_uri . '/products/left_sidebar.jpg'),
                        ),
                        'default' => 'default',
                        'transport' => 'refresh',
                    ),
                    ...
                    array(
                        ...
                        'type' => 'button_set',
                        'default' => 'select',
                        'options' => array('button' => __('Image / Color swatch', 'porto'), 'select' => __('Select Box', 'porto')),
                    ),
                    array(
        ...
        public function setArguments() {
            ...
            if ( get_theme_mod( 'theme_options_use_new_style', false ) ) {
                $menu_title = __('Advanced Options', 'porto');
                $customize_options_link = '<a class="porto-theme-link" href="' . admin_url('customize.php') . '">Theme Options</a>';
                $new_options_link = '';
            } else {
                $menu_title = __('Theme Options', 'porto');
                $customize_options_link = '';
                $new_options_link = '<a href="#" class="porto-theme-link switch-live-option-panel">'. __( 'Live Option Panel', 'porto' ) .'</a>';
            }
            $this->args = array(
                'opt_name' => 'porto_settings',
                'display_name' => $theme->get('Name') . ' ' . $menu_title . '<a class="porto-theme-link" href="' . admin_url('admin.php?page=porto') . '">Welcome</a><a class="porto-theme-link" href="' . admin_url('admin.php?page=porto') . '">Theme License</a><a class="porto-theme-link" href="' . admin_url('admin.php?page=porto-changelog') . '">Change log</a>'. $customize_options_link .'<a class="porto-theme-link" href="' . admin_url('admin.php?page=porto-setup-wizard') . '">Setup Wizard</a><a class="porto-theme-link porto-theme-link-last" href="' . admin_url('admin.php?page=porto-speed-optimize-wizard') . '">Speed Optimize Wizard</a>'. $new_options_link,
