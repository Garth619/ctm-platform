                ...
                foreach ( $this->parent->sections as $key => $section ) {
                    ...
                    foreach ( $section['fields'] as $skey => $option ) {
                        ...
                        if ( $option['id'] == $this->parent->args['opt_name'] . '[css-code]' ) {
                            ...
                            $wp_customize->add_control( new WP_Customize_Code_Editor_Control( $wp_customize, $option['id'], array(
                                'label'           => $option['title'],
                                'section'         => $section['id'],
                                'settings'        => $option['id'],
                                'code_type'       => 'text/css',
                            ) ) );
                        } else if ( $option['id'] == $this->parent->args['opt_name'] . '[js-code-head]' || $option['id'] == $this->parent->args['opt_name'] . '[js-code]' ) {
                            $wp_customize->add_control( new WP_Customize_Code_Editor_Control( $wp_customize, $option['id'], array(
