<?php
global $porto_settings, $porto_layout, $porto_sidebar, $porto_shop_filter_layout;
wp_reset_postdata();
...
if ($porto_layout == 'wide-left-sidebar' || $porto_layout == 'wide-right-sidebar' || $porto_layout == 'left-sidebar' || $porto_layout == 'right-sidebar') : ?>
    <div class="col-lg-3 sidebar <?php echo 'porto-'. $porto_sidebar; ?> <?php echo str_replace('wide-', '', $porto_layout) ?><?php echo $mobile_sidebar ? ' mobile-sidebar' : '' ?>"><!-- main sidebar -->
