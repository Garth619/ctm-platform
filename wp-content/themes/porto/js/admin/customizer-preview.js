jQuery(document).ready(function($) {
    ...
    if (hasSelectiveRefresh) {
        ...
        $(window).load(function() {
            setTimeout(function() {
                $('head > style#porto-dynamic-css-output').removeAttr('title');
            }, 1000);
        });
        ...
        wp.customize.selectiveRefresh.bind('partial-content-rendered', function (placement) {
            ...
            if (placement.partial.id == 'header-wrapper' || placement.partial.id == 'header') {
                ...
                $('head > style#porto-dynamic-css-output-temp').remove();
                $('head > style#porto-dynamic-css-output').clone().attr('id', 'porto-dynamic-css-output-temp').insertAfter($('head > style#porto-dynamic-css-output'));
    ...
    wp.customize('porto_settings[header-main-padding]', function(e) {
        e.bind(function(padding) {
            var css = '';
            if (padding['padding-top'] || padding['padding-bottom']) {
                css += '#header .header-main .header-left, #header .header-main .header-center, #header .header-main .header-right {';
    ...
    wp.customize('porto_settings[header-top-height]', function(e) {
        e.bind(function(value) {
            appendStyle('porto_settings[header-top-height]', '.header-top { min-height: ' + value + 'px; }');
        });
    });
    wp.customize('porto_settings[header-bottom-height]', function(e) {
        e.bind(function(value) {
            appendStyle('porto_settings[header-bottom-height]', '.header-bottom { min-height: ' + value + 'px; }');
        });
    });
    ...
    var paddingOptions = {'mainmenu-wrap-padding': '.main-menu-wrap', 'mainmenu-wrap-padding-sticky': '#header.sticky-header .main-menu-wrap'};
    ...
    wp.customize('porto_settings[sticky-searchform-popup-border-color]', function(e) {
        e.bind(function(value) {
            appendStyle('porto_settings[sticky-searchform-popup-border-color]', ( value ? '#header.sticky-header .searchform-popup .searchform { border-color: ' + value + '} #header.sticky-header .searchform-popup .search-toggle:after { border-bottom-color: ' + value + '}' : '' ) );
        });
    });
    ...
    wp.customize('porto_settings[sticky-minicart-bg-color]', function(e) {
        e.bind(function(value) {
            appendStyle('porto_settings[sticky-minicart-bg-color]', ( value ? '.sticky-header #mini-cart .cart-popup { border: 1px solid ' + value + '} .sticky-header #mini-cart .cart-popup:after{ border-bottom-color: ' + value + '}' : '' ) );
        });
    });
    ...
    wp.customize('porto_settings[menu-type]', function(e) {
        e.bind(function(value) {
            $('.main-menu.mega-menu, .main-menu-wrap').removeClass('menu-flat').removeClass('menu-flat-border').removeClass('side');
            if (value) {
