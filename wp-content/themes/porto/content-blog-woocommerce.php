...
<article <?php post_class($post_class); ?>>
    ...
    if ($slideshow_type != 'none') : ?>
        <?php if ($slideshow_type == 'images') :
            ...
            <div class="post-image<?php if ($image_count == 1) echo ' single'; ?>">
                <div class="post-slideshow porto-carousel owl-carousel" data-plugin-options='<?php echo json_encode( array( 'dots' => false, 'nav' => true ) ); ?>'>
                    <?php
                        ...
                        if ( $attachment ) {
                            ...
                            <a href="<?php echo esc_url( apply_filters( 'the_permalink', get_permalink() ) ) ?>">
                                <div class="img-thumbnail">
                                    <img class="owl-lazy img-responsive" width="<?php echo $attachment['width'] ?>" height="<?php echo $attachment['height'] ?>" src="<?php echo esc_url( $placeholder[0] ); ?>" data-src="<?php echo $attachment['src'] ?>" alt="<?php echo $attachment['alt'] ?>" />
	...
	<a class="read-more" href="<?php echo esc_url( apply_filters( 'the_permalink', get_permalink() ) ) ?>"><?php _e('Read more...', 'porto') ?></a>
