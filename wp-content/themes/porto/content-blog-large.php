...
if ($porto_settings['post-title-style'] == 'without-icon')
    $post_class[] = 'post-title-simple';$post_meta = '';
...
<article <?php post_class($post_class); ?>>
	...
	<!-- Post meta before content -->    	<?php if( 'before' === $porto_settings['post-meta-position'] ) echo $post_meta;?>
	...
	<!-- Post meta after content -->	<?php if( 'before' !== $porto_settings['post-meta-position'] ) echo $post_meta; ?>
