...
<div class="crm_clear"></div> 
 ...
 $req_span2=" <span class='vx_red vx_required vx_req_parent'>(".__('Required','contact-form-zoho-crm').")</span>";
  ...
  $options=$this->form_fields_options($form_id,$this->account,$feed['id'],$sel_val); 
...
<div class="entry_row vxc_field_op">
<div class="entry_col1 vx_label"><label for="vx_vals_<?php echo $k ?>"> <?php _e('Option Values','contact-form-zoho-crm') ?></label></div>
<div class="entry_col2">
<textarea readonly="readonly" style="height: 100px" id="vx_vals_<?php echo $k ?>" class='vx_input_100 vxc_field_op_input'></textarea>
</div>
<div class="crm_clear"></div>
</div> 
...
<div class="crm_clear"></div> 
  ...
  <?php 
  echo $this->form_fields_options($form_id,$this->account,$id,$this->post('field',$s_v));
                ?>
  </select>
  </div>
...
<div class="vx_div vx_refresh_panel ">    
      <div class="vx_head ">
<div class="crm_head_div"> <?php echo sprintf(__('%s. Object Owner',  'contact-form-zoho-crm' ),$panel_count); ?></div>
<div class="crm_btn_div"><i class="fa crm_toggle_btn fa-minus" title="<?php _e('Expand / Collapse','contact-form-zoho-crm') ?>"></i></div>
<div class="crm_clear"></div> 
  </div>                 
    <div class="vx_group ">
   <div class="vx_row"> 
   <div class="vx_col1"> 
  <label for="crm_owner"><?php _e("Assign Owner", 'contact-form-zoho-crm'); $this->tooltip('vx_owner_check');?></label>
  </div>
  <div class="vx_col2">
  <input type="checkbox" style="margin-top: 0px;" id="crm_owner" class="crm_toggle_check <?php if(empty($users)){echo 'vx_refresh_btn';} ?>" name="meta[owner]" value="1" <?php echo !empty($meta["owner"]) ? "checked='checked'" : ""?> autocomplete="off"/>
    <label for="owner"><?php _e("Enable", 'contact-form-zoho-crm'); ?></label>
  </div>
<div class="clear"></div>
</div>
  ...
  <div class="vx_row">
  <div class="vx_col1">
  <label><?php _e('Users List','contact-form-zoho-crm'); $this->tooltip('vx_owners'); ?></label>
  </div>
  <div class="vx_col2">
  <button class="button vx_refresh_data" data-id="refresh_users" type="button" autocomplete="off" style="vertical-align: baseline;">
  <span class="reg_ok"><i class="fa fa-refresh"></i> <?php _e('Refresh Data','contact-form-zoho-crm') ?></span>
  ...
  <div class="vx_row">
   <div class="vx_col1">
  <label for="crm_sel_user"><?php _e('Select User','contact-form-zoho-crm'); $this->tooltip('vx_sel_owner'); ?></label>
</div> 
<div class="vx_col2">

  <select id="crm_sel_user" name="meta[user]" style="width: 100%;" class="vx_input_100" autocomplete="off">
  <?php echo $this->gen_select($users,$meta_user,__('Select User','contact-form-zoho-crm')); ?>
  </select>
...
if(in_array($module,array('Leads','Contacts'))){ 
  ...
  ?>
    <div class="vx_div vx_refresh_panel ">    
      <div class="vx_head ">
<div class="crm_head_div"> <?php  echo sprintf(__('%s. Add as Campaign Member',  'contact-form-zoho-crm' ),$panel_count); ?></div>
<div class="crm_btn_div"><i class="fa crm_toggle_btn fa-minus" title="<?php _e('Expand / Collapse','contact-form-zoho-crm') ?>"></i></div>
<div class="crm_clear"></div> 
  </div>                 
    <div class="vx_group ">
   <div class="vx_row"> 
   <div class="vx_col1"> 
  <label for="crm_camp"><?php _e("Add to Campaign ", 'contact-form-zoho-crm'); $this->tooltip('vx_camp_check');?></label>
  </div>
  <div class="vx_col2">
  <input type="checkbox" style="margin-top: 0px;" id="crm_camp" class="crm_toggle_check <?php if(empty($member_status_arr) && empty($campaigns)){echo 'vx_refresh_btn';} ?>" name="meta[add_to_camp]" value="1" <?php echo !empty($meta["add_to_camp"]) ? "checked='checked'" : ""?> autocomplete="off"/>
    <label for="crm_optin"><?php _e("Enable", 'contact-form-zoho-crm'); ?></label>
  </div>
<div class="clear"></div>
</div>
  ...
  <div class="vx_row">
  <div class="vx_col1">
  <label><?php _e('Campaign & Status Lists ','contact-form-zoho-crm'); $this->tooltip('vx_camps'); ?></label>
  </div>
  <div class="vx_col2">
  ...
  <div class="vx_row">
   <div class="vx_col1">
  <label for="crm_sel_camp"><?php _e('Select Campaign ','contact-form-zoho-crm'); $this->tooltip('vx_sel_camp'); ?></label>
</div> <div class="vx_col2">
  ...
  <?php echo $this->gen_select($campaigns,$meta['campaign'],__('Select Campaign','contact-form-zoho-crm')); ?>
  </select>
  <input type="text" name="meta[campaign_id]" id="crm_camp_id" value="<?php echo $this->post('campaign_id',$meta); ?>" style="vertical-align: middle; width: 100%; <?php if($this->post('camp_type',$meta) == ""){echo 'display: none';} ?>" placeholder="<?php _e('Enter Campaign ID','contact-form-zoho-crm') ?>" autocomplete="off">
...
<div class="crm_clear"></div> 
  ...
  <?php echo $this->form_fields_options($form_id,$this->account,$id,$this->post('note_fields',$meta)); ?>
  </select>
    <span class="howto">
  <?php _e('You can select multiple fields.', 'contact-form-zoho-crm'); ?>
  </span>
   </div>
  <div style="clear: both;"></div>
  </div>
