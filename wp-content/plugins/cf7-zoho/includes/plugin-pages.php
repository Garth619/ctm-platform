...
//
  ...
  $fields=$api->get_crm_fields($module); 
     ...
     $temp_fields=array(); $phones=array('Phone','AsstPhone','OtherPhone','HomePhone','tags','vx_attachments');
...
$fields=array('cf'=>array("title"=>__('Contact Form Fields','contact-form-zoho-crm'),"fields"=>$fields));
  ...
  */
  public  function  form_fields_options($form_id,$account,$feed_id,$sel_val=""){
  if($this->fields == null){
