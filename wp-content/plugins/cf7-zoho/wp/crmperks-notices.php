...
add_action('vx_plugin_upgrade_notice_'.$this->type, array($this, 'notice_all'),99);
...
<p><a href="<?php echo $url ?>" style="font-weight: bold;"><?php _e('Install 100% free Conatct Form Entries Plugin','crm-perks-forms') ?></a> </p>
</div>
<?php
}
  } 
...
$msg =sprintf(__('Want to save conatct form 7 submissions? Manage contact form 7 entries , view Zoho status of any entry and Resend any entry to Zoho CRM with free %sConatct Form Entries Plugin%s','crm-perks-forms'),'<a href="https://wordpress.org/plugins/contact-form-entries/" target="_blank">','</a>');
?>
...
<p><i class="fa fa-check"></i> Zoho file attachments.</p>
