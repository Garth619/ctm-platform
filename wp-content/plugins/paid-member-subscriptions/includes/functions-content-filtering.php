...
if ( ! defined( 'ABSPATH' ) ) exit;
    ...
    function pms_payment_error_message( $content = '' ) {
        ...
        $error = apply_filters( 'pms_payment_error_message', $error, $_GET['pms_is_register'], $_GET['pms_payment_id'] );


        return apply_filters( 'pms_payment_error_message_output', '<div class="pms_field-errors-wrapper pms-stripe-payment-error"><p>' . $error . '</p></div>', $_GET['pms_is_register'], $_GET['pms_payment_id'] );
