...
if (defined('WCPA_POST_TYPE') && defined('WCPA_VERSION')) {//to check free version alredy running
    add_action('admin_notices', function() {
        ?>
        <div class="error">
            <p>It is found that free version of this plugin <strong> Woocommerce Custom Product Addons</strong> is running on this site.
    ...
    define('WCPA_TEXT_DOMAIN', 'wcpa-text-domain');
