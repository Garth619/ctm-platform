...
use BeeketingConnect_beeketing_woocommerce_salespop\Common\Data\Manager\VariantManagerAbstract;
    ...
    public function formatVariant($variant, $product)
    {
        ...
        if ($variant->is_type('variation')) {
            ...
            foreach ($variant->get_variation_attributes() as $attributeName => $attribute) {
                ...
                $product_attribute_name = str_replace('attribute_', null, $attributeName);
                if (
                    !$attribute &&
