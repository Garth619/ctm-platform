...
class WOO_MSTORE_admin_products {
	...
	public function admin_print_scripts() {
		...
		wp_enqueue_script( 'bulk-distribution', WOO_MSTORE_URL . '/assets/js/bulk-distribution.js', array( 'jquery' ) );
	}
	...
	public function network_products_interface() {
			...
			require_once( WOO_MSTORE_PATH . '/include/admin/views/html-bulk-distribution-product.php' );
		}
}
