...
class Porto_WC_Widget_Price_Filter extends WP_Widget {
    ...
    public function __construct() {
        ...
        $widget_ops = array('classname' => 'woocommerce porto_widget_price_filter', 'description' => __('Display input boxes to filter products in your store by price.', 'porto-widgets'));

        $control_ops = array('id_base' => 'porto_woocommerce_price_filter-widget');

        parent::__construct('porto_woocommerce_price_filter-widget', __('Porto: Woocommerce Price Filter', 'porto-widgets'), $widget_ops, $control_ops);
    }
    ...
    function form($instance) {
        ...
        $defaults = array('title' => __('Price', 'porto-widgets'));
