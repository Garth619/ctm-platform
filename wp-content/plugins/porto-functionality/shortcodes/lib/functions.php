    ...
    $html .= '<div class="porto-bs-select-block">';
        $html .= '<div class="porto-bs-select-wrap">';
            $html .= '<select class="porto-bs-select" >';
                ...
                $html .= '<option value="inherit"'. ( isset( $settings['default_style'] ) && 'inherit' == $settings['default_style'] ? ' selected="selected"' : '' ) .'>'. esc_html__( 'Inherit','porto-shortcodes' ) .'</option>';
                $html .= '<option value="inset"'. ( isset( $settings['default_style'] ) && 'inset' == $settings['default_style'] ? ' selected="selected"' : '' ) .'>'. esc_html__( 'Inset','porto-shortcodes' ) .'</option>';
                $html .= '<option value="outset"'. ( isset( $settings['default_style'] ) && 'outset' == $settings['default_style'] ? ' selected="selected"' : '' ) .'>'. esc_html__( 'Outset','porto-shortcodes' ) .'</option>';
            $html .= '</select>';
        $html .= '</div>';
    $html .= '</div>';
...
function porto_sc_parse_google_font( $fontsString ) {
    if ( !class_exists( 'Vc_Google_Fonts' ) ) {
        return false;
    }
    $googleFontsParam = new Vc_Google_Fonts();
    $fieldSettings = array();
    $fontsData = $fontsString ? $googleFontsParam->_vc_google_fonts_parse_attributes( $fieldSettings, $fontsString ) : '';
    return $fontsData;
}
function porto_sc_google_font_styles( $fontsData ) {
...
function porto_sc_enqueue_google_fonts( $fontsData ) {
    ...
    foreach( $fontsData as $fontData ) {
        ...
        if ( !isset( $fontData['values']['font_family'] ) ) {
            continue;
        }
        $font_family = explode( ':', $fontData['values']['font_family'] );
        ...
        $fonts_str .= $fontData['values']['font_family'];
