...
if ( !class_exists( 'PortoBlocksClass' ) ) :
    class PortoBlocksClass {
        ...
        function registerRestAPI() {
            ...
            register_rest_field( 'post', 'featured_image_src',
                array(
        ...
        public function featuredImageSrc($object) {
            ...
            return array( 'landsacpe' => $featured_img_large, 'list' => $featured_img_list, 'medium' => $featured_img_medium, 'full' => $featured_img_full );
        }
    }
endif;
