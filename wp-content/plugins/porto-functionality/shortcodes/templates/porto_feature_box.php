...
if (!$show_icon)
    $icon_class = '';
if( $box_style == '' || $box_style == 'feature-box-style-3' || $box_style == 'feature-box-style-6' ) {
...
if ($icon_class) {
    $output .= '<div class="feature-box-icon'. ($skin != 'custom' ? ' feature-box-icon-' . $skin : '') .'"'.$icon_circle_style.'><i class="' . $icon_class . '" style="font-size:'.$icon_size.'px">';
