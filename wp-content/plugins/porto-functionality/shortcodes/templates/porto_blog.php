...
if ( $posts->have_posts() ) {
    ...
    if ($post_layout == 'timeline') {
        ...
        <div class="blog-posts posts-<?php echo esc_attr( $post_layout ); ?><?php echo $post_style ? ' blog-posts-'. esc_attr( $post_style ) : ''; ?>">
            <section class="timeline">
                <div class="timeline-body">

    <?php } else if ($post_layout == 'grid' || $post_layout == 'masonry') {
