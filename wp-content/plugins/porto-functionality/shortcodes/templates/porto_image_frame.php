...
if ($image_url) {
    ...
    if ($type == '') {
        ...
        if ($shape !== 'thumbnail') {
            $output .= '<img alt="" src="' . esc_url( $image_url ) . '" class="img-responsive img-' . $shape . ($boxshadow ? ' img-box-shadow': '') . '">';
        } else {
            $output .= '<span class="img-thumbnail">';
            $output .= '<img alt="" src="' . esc_url( $image_url ) . '" class="img-responsive' . ($boxshadow ? ' img-box-shadow': '') . '">';
            $output .= '</span>';
        }
        ...
        $output .= '<img alt="" src="' . esc_url( $image_url ) . '" class="img-responsive"' . (($view_type === 'side-image' || $view_type === 'side-image-right') && $img_width ? ' style="max-width:' . (int)$img_width . 'px"' : '') . '>';
        ...
        if ($content || $show_socials || (($view_type === 'side-image' || $view_type === 'side-image-right') && ($title || $date || $sub_title))) {
            ...
            if ($content || ($view_type === 'side-image' || $view_type === 'side-image-right') && ($title || $sub_title)) {
                ...
                $output .= do_shortcode(porto_clean_shortcodes(wpautop($content)));
