...
if ( function_exists( 'register_block_type' ) ) {
    register_block_type( 'porto/porto-carousel', array(
        'editor_script'   => 'porto_blocks',
        'render_callback' => 'porto_shortcode_carousel',
    ) );
}
...
function porto_load_carousel_shortcode() {
    ...
    vc_map( array(
        ...
        "params" => array(
            ...
            array(
                'type' => 'checkbox',
                'heading' => __("Infinite loop", 'porto-shortcodes'),
                'param_name' => 'loop',
                'value' => array( __( 'Yes', 'js_composer' ) => 'yes' ),
            ...
            array(
                ...
                'param_name' => 'lazyload',
                'value' => array( __( 'Yes', 'js_composer' ) => 'yes' ),
                "description" => __('Please edit lazy load images using porto carousel item element or porto interactive banner element.', 'porto-shortcodes'),
                "group" => __('Advanced', 'porto-shortcodes')
            ),
            array(
                'type' => 'checkbox',
