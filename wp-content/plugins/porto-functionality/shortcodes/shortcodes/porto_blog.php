...
if ( function_exists( 'register_block_type' ) ) {
    register_block_type( 'porto/porto-blog', array(
    ...
    vc_map( array(
        ...
        "params" => array(
            ...
            array(
                ...
                'dependency' => array('element' => 'post_layout', 'value' => array( 'grid', 'masonry', 'timeline' )),
                "value" => array(
                    __( 'Default', 'porto-shortcodes' ) => 'default',
                    __( 'Post Carousel Style', 'porto-shortcodes' ) => 'related',
                    __( 'Hover Info', 'porto' ) => 'hover_info',
                    __( 'No Margin & Hover Info', 'porto' ) => 'no_margin',
                    __( 'With Borders', 'porto' ) => 'padding',
                )
            ),
            array(
                "type" => "dropdown",
            ...
            array(
                "type" => "dropdown",
                "heading" => __("Pagination Style", 'porto-shortcodes'),
                "param_name" => "view_more",
                "value" => array(
                    __( 'No Pagination', 'porto-shortcodes' ) => '',
                    __( 'Show Pagination', 'porto-shortcodes' ) => 'show',
                    __( 'Show Blog Page Link', 'porto' ) => 'link',
                )
            ),
            array(
                'type' => 'textfield',
                ...
                'dependency' => array( 'element' => 'view_more', 'value' => array( 'link' ) ),
            ),
            $custom_class,
            $animation_type,
            $animation_duration,
