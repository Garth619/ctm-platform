...
if ( function_exists( 'register_block_type' ) ) {
    register_block_type( 'porto/porto-stat-counter', array(
           ...
           "params" => array(
              ...
              array(
                ...
                array(
                    ...
                    "text" => __("Counter Title settings","porto-shortcodes"),
                    "group" => "Typography",
                ),
                array(
                    'type' => 'checkbox',
                ...
                array(
                    ...
                    'dependency' => array('element' => 'title_use_theme_fonts', 'value_not_equal_to' => 'yes'),
                    'group' => 'Typography'
                ),
                array(
                    "type" => "textfield",
                ...
                array(
                    ...
                    "text" => __("Counter Value settings","porto-shortcodes"),
                    "group" => "Typography",
                ),
                array(
                    'type' => 'checkbox',
                ...
                array(
                    ...
                    'dependency' => array('element' => 'desc_use_theme_fonts', 'value_not_equal_to' => 'yes'),
                    'group' => 'Typography'
                ),
                array(
                    "type" => "textfield",
                ...
                array(
                    ...
                    "text" => __("Counter suffix-prefix Value settings","porto-shortcodes"),
                    "group" => "Typography",
                ),
                array(
                    'type' => 'checkbox',
                ...
                array(
                    ...
                    'dependency' => array('element' => 'suf_pref_use_theme_fonts', 'value_not_equal_to' => 'yes'),
                    'group' => 'Typography'
                ),
                array(
                    "type" => "textfield",
