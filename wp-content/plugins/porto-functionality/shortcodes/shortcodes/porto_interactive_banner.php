...
if ( function_exists( 'register_block_type' ) ) {
    register_block_type( 'porto/porto-interactive-banner', array(
        ...
        array(
           ...
           "params" => array(
                ...
                array(
                    ...
                    "description" => __( 'If you have this element in Porto Carousel, please check "Lazy Load" option in Porto Carousel element.', 'porto-shortcodes' ),
